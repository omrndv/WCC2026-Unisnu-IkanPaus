...
@section('title', 'Warisan Digital - Sejarah Getuk Goreng Asri')
...
@section('content')
    <section class="relative bg-primary pt-36 pb-32 overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <span
                class="about-hero-text opacity-0 inline-block py-1.5 px-5 border border-highlight/50 bg-white/10 backdrop-blur-md text-highlight rounded-full text-xs font-semibold tracking-[0.2em] uppercase mb-6 shadow-lg">
                Sejak Tahun 1940
            </span>
            <h1 class="about-hero-text opacity-0 text-5xl md:text-6xl lg:text-7xl font-title text-white mb-6 leading-[1.1]">
                Menjaga Rasa, <br> <span class="italic text-highlight">Merawat Tradisi</span>
            </h1>
            <p class="about-hero-text opacity-0 text-lg text-white/70 font-light max-w-2xl mx-auto leading-relaxed">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-12 md:gap-20 items-center mb-32">
                ...
                <div class="reveal-right">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-title text-primary font-bold mb-6 leading-tight">Resep
                        yang Lahir dari <br><span class="italic font-light">Ketidaksengajaan</span></h3>
            ...
            <div class="grid md:grid-cols-2 gap-12 md:gap-20 items-center mb-32">
                <div class="order-2 md:order-1 reveal-left">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-title text-primary font-bold mb-6 leading-tight">Kuali
                        Tembaga & <br><span class="italic font-light">Api Kayu Bakar</span></h3>
                    <p class="text-gray-600 font-light leading-relaxed mb-6 text-lg">
                ...
                <div class="order-1 md:order-2 relative group reveal-right">
                    <div
    ...
    <section class="py-24 bg-primary text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center mb-16 reveal-fade">
                <h3 class="text-3xl md:text-5xl font-title mb-4">Rahasia di Balik <span class="italic text-highlight">Satu
                        Gigitan</span></h3>
                <p class="font-light text-white/80 max-w-2xl mx-auto">Kami menolak kompromi. Rasa yang melegenda hanya bisa
                    diciptakan dari bahan-bahan yang dirawat dengan doa dan keringat petani lokal.</p>
            </div>

            <div class="grid md:grid-cols-2 gap-8">
                <div
                    class="bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-[2.5rem] hover:bg-white/10 transition-colors reveal-up">
                    <div
                ...
                <div
                    class="bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-[2.5rem] hover:bg-white/10 transition-colors reveal-up delay-100">
                    <div
                        class="w-16 h-16 rounded-full bg-highlight flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(244,168,67,0.4)]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="py-32 bg-[#FAF8F5] overflow-hidden">
        <div class="container mx-auto px-6">
            <div class="text-center mb-24 reveal-fade">
                <h3 class="text-4xl md:text-5xl font-title text-primary mb-6">Jejak Langkah <span
                        class="italic text-highlight">Sang Legenda</span></h3>
                ...
                <div class="space-y-24">
                    <div class="relative flex flex-col md:flex-row items-center timeline-item">
                        <div class="flex-1 md:text-right md:pr-16 mb-8 md:mb-0">
                            ...
                            <p class="text-gray-500 font-light leading-relaxed">Mbah Asri mulai menjajakan getuk goreng
                                secara asongan di Sokaraja. Bermodal pikulan bambu dan senyum yang ramah.</p>
                        </div>
                        <div
                    ...
                    <div class="relative flex flex-col md:flex-row items-center timeline-item">
                        ...
                        <div class="flex-1 md:text-left md:pl-16 mt-8 md:mt-0">
                            ...
                            <p class="text-gray-500 font-light leading-relaxed">Proses penumbukan singkong mulai
                                dimodifikasi untuk mendapatkan tekstur yang lebih kalis. Getuk Asri mulai dikenal di luar
                                Banyumas.</p>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center timeline-item">
                        <div class="flex-1 md:text-right md:pr-16 mb-8 md:mb-0">
                            ...
                            <p class="text-gray-500 font-light leading-relaxed">Mendirikan gerai permanen yang ikonik. Di
                                era ini, kemasan *besek bambu* mulai dipatenkan sebagai identitas visual buah tangan khas
                                Banyumas.</p>
                        </div>
                        <div
                            class="w-16 h-16 bg-white rounded-full border-4 border-highlight shadow-[0_0_30px_rgba(244,168,67,0.3)] z-10 flex items-center justify-center shrink-0">
                    ...
                    <div class="relative flex flex-col md:flex-row items-center timeline-item">
                        ...
                        <div class="flex-1 md:text-left md:pl-16 mt-8 md:mt-0">
                            ...
                            <p class="text-gray-500 font-light leading-relaxed">Menjawab tantangan zaman, kami meluncurkan
                                varian Cokelat Lumer dan Keju Susu tanpa mengubah metode penggorengan tradisional.</p>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center timeline-item">
                        <div class="flex-1 md:text-right md:pr-16 mb-8 md:mb-0">
                            <span
                                class="text-6xl font-title text-highlight/40 block mb-2 tracking-widest text-shadow">2026</span>
                            <h4 class="text-2xl font-bold text-primary mb-3">Lompatan Digital</h4>
                            <p class="text-gray-500 font-light leading-relaxed">Platform *Warisan Rasa Banyumas*
                                diluncurkan terintegrasi dengan KasirPro. Membawa warisan Mbah Asri dari etalase lokal
                                menuju panggung global.</p>
                        </div>
                        <div
                            class="w-20 h-20 bg-highlight rounded-full border-4 border-white shadow-[0_0_40px_rgba(244,168,67,0.6)] z-10 flex items-center justify-center shrink-0 animate-bounce">
    ...
    <section class="py-24 bg-white value-section">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16 reveal-fade">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div
                    class="bg-gray-50 p-10 md:p-12 rounded-[2.5rem] border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 value-card">
                    <div
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">Menolak menggunakan bahan pengawet dan perasa
                        buatan demi menjaga keaslian rasa sesuai wasiat pendiri.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">Memberikan lapangan kerja bagi ibu-ibu dan
                        pengrajin besek bambu lokal di wilayah Sokaraja dan sekitarnya.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">Berkomitmen pada *packaging* berkelanjutan
                        (sustainable) yang mudah terurai oleh alam demi kelestarian bumi.</p>
                </div>
            </div>
        </div>
    </section>
